...
def generate_output_files(grid):
    ...
    if output_settings.print_field:
        ...
        output_field = os.path.join(field_path, 'field_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
    ...
    if output_settings.print_performance:
        ...
        output_performance = os.path.join(performance_path, 'performance_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
    ...
    if output_settings.print_iters:
        ...
        output_iters = os.path.join(iters_path, 'iters_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
    ...
    if output_settings.print_energy:
        ...
        output_energy = os.path.join(energy_path, 'energy_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
    ...
    if output_settings.print_temperature:
        ...
        output_temperature = os.path.join(temperature_path, 'temperature_N' + str(N) + '_N_p_'+str(N_p)+ '.csv')
    ...
    if output_settings.print_solute:
        ...
        output_solute = os.path.join(solute_path, 'solute_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
    ...
    if output_settings.print_tot_force:
        ...
        output_tot_force = os.path.join(force_path, 'tot_force_N' + str(N) + '_N_p_'+str(N_p)+'.csv')
