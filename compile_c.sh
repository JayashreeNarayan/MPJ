...
/opt/homebrew/Cellar/gcc/14.2.0_1/bin/gcc-14 -O3 --fast-math -shared laplace.c -o maze_poisson/liblaplace.so -fopenmp -fPIC

# Check if the build was successful
if [ $? -eq 0 ]; then
    echo "Build successful! The shared library has been created at 'maze_poisson/liblaplace.so'."
else
